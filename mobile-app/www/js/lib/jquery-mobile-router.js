...
(function(root, factory) {
    ...
    $(document).on("mobileinit", function(){
        /* supports the following configurations:
         ...
         $.mobile.jqmRouter.firstPageDataUrl="defaultHandler.html"
         ...
         "firstPageDataUrl" property (for example: defaultHandler.html)
         */

        var config = $.extend({
            fixFirstPageDataUrl: false, firstPageDataUrl: "defaultHandler.html",
